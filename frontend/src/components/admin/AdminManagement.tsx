  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-xl font-bold text-gray-800 font-outer-sans">Administradores do Sistema</h3>
          <p className="text-sm text-gray-600 font-outer-sans mt-1">
      ...
      {showForm && (
        <div className="card-gradient p-6 animate-slide-up">
          <div className="flex items-center justify-between mb-4">
            <h4 className="text-lg font-bold text-gray-800 font-outer-sans">Novo Administrador</h4>
            <button
              onClick={() => {
                setShowForm(false);
                setFormData({ name: '', email: '', password: '' });
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <button type="submit" className="btn btn-primary font-outer-sans">
                Criar Administrador
              </button>
            </div>
          </form>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider font-outer-sans">
                    Nome
                  </th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider font-outer-sans">
                    Email
                  ...
                  <tr key={admin.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 to-orange-500 flex items-center justify-center text-white font-semibold font-outer-sans">
                          {admin.name.charAt(0).toUpperCase()}
                        </div>
                        <div className="ml-4">
                          <div className="text-sm font-medium text-gray-900 font-outer-sans">
                            {admin.name}
                          </div>
                        </div>
                      </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 font-outer-sans">{admin.email}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
